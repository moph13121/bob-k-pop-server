        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Ratings_Product_product_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_product_wishlist", x => new { x.ProductsId, x.WishlistsId });
                    table.ForeignKey(
                        name: "FK_product_wishlist_Product_ProductsId",
                        column: x => x.ProductsId,
                        principalTable: "Product",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_product_wishlist_Wishlist_WishlistsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_product_wishlist_WishlistsId",
